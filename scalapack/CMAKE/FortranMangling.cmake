...
FUNCTION(COMPILE RESULT)
   ...
   # Configure: 
    EXECUTE_PROCESS(
      COMMAND ${CMAKE_COMMAND} -DCMAKE_Fortran_COMPILER=${CMAKE_Fortran_COMPILER} -DCMAKE_C_COMPILER=${CMAKE_C_COMPILER} ${PROJECT_SOURCE_DIR}/BLACS/INSTALL/
    ...
    if(RESVAR EQUAL 0)
      ...
      MESSAGE(ERROR " BLACS configure log:\n ${LOG1}")
      MESSAGE(FATAL_ERROR " Configure in the BLACS INSTALL directory FAILED ${RESVAR}")
    endif()

    # Build:
    EXECUTE_PROCESS(COMMAND ${CMAKE_COMMAND} --build ${PROJECT_SOURCE_DIR}/BLACS/INSTALL/ 
        RESULT_VARIABLE RESVAR 
        OUTPUT_VARIABLE LOG2 ERROR_VARIABLE LOG2
    )
    if(RESVAR EQUAL 0)
      MESSAGE(STATUS "Build in the BLACS INSTALL directory successful")
    else()
      MESSAGE(ERROR " BLACS Build log:\n ${LOG2}")
      MESSAGE(FATAL_ERROR " Build in the BLACS INSTALL directory FAILED ${RESVAR}")
